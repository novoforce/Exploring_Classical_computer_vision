...
def draw_rectangle(image):
    cv2.rectangle(image,pt1=(200,200),pt2=(300,300),thickness=2,color=(255,0,0))
    cv2.rectangle(image,pt1=(400,10),pt2=(500,150),thickness=2,color=(255,255,0))
    display(image)
    return image

def draw_circle(image):
    cv2.circle(image,center=(250,250),radius=50,color=(255,255,255),thickness=2)
    cv2.circle(image,center=(400,400),radius=50,color=(255,255,255),thickness=-1)
    display(image)
    return image
...
def draw_text(image):
    ...
    cv2.putText(image,text="Hello Deepindra",
    org=(10,500),fontFace=font,fontScale=1,color=(255,255,255),
